<div class="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
    <img class="object-cover object-center w-full h-56" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQTOQfeIWQPpvYLdscoHF_zolBg95FFKiBe4j_esvvjTg&s=10" alt="avatar">
    ...
    <div class="flex items-center px-6 py-3 bg-gray-900">
        ...
        <h1 class="mx-3 text-lg font-semibold text-white">Focando</h1>
    </div>

    <div class="px-6 py-4">
        <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Marcos Vinícius </h1>

        <p class="py-2 text-gray-700 dark:text-gray-400">Full Stack, Amo progamação e design.</p>
        ...
        <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
            ...
            <h1 class="px-2 text-sm">Full Stack</h1>
        </div>
        ...
        <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
            ...
            <h1 class="px-2 text-sm">Tatuí, SP</h1>
        </div>
        ...
        <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
            ...
            <h1 class="px-2 text-sm">marcos@example.com</h1>
        </div>
    </div>
</div>
